...
def run_demo(net, image_provider, height_size, cpu, track, smooth,standardpose):
    net = net.eval()
    if not cpu:
        net = net.cpu()
...
if __name__ == '__main__':
    ...
    # img = cv2.imread("C:/Users/29943/Pictures/Camera Roll/WIN_20230813_22_41_02_Pro.jpg")
    ...
    standard_pose.draw_single_pose(img)
    run_demo(net, frame_provider, args.height_size, args.cpu, args.track, args.smooth,standard_pose)
